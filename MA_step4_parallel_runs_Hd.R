...
# R
# setwd(" ")
# source("MA_step4_parallel_runs_Hd.R")
...
#     filename <- paste("runs/M1.",i,"_test.Rdata",sep="") # Remember to change the number so that files have different names.
#     df<-Z_data_list[[2]]
#     d<-df$H.d
#     vofd<-df$SE.d
...
# ######################################################################################
# ### Null models - study_ID and animal_ID as random effects (Model 1), controlling for shared controls
# ######################################################################################
# 
...
#       filename <- paste("runs/M1.",i,"_sub",j,".Rdata",sep="") # Remember to change the number so that files have different names.
# 
